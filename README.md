...
Runge-Kutta is a more accurate method, as we will see. It involves taking multiple evaluations across the time step of length h to get a more accurate approximation of u_(i+1). 
